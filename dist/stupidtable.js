(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("stupidtable", ["cash-dom"], factory);
	else if(typeof exports === 'object')
		exports["stupidtable"] = factory(require("cash-dom"));
	else
		root["stupidtable"] = factory(root["cash-dom"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE__866__) {
...
module.exports = __WEBPACK_EXTERNAL_MODULE__866__;
...
/* harmony import */ var cash_dom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(866);
/* harmony import */ var cash_dom__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(cash_dom__WEBPACK_IMPORTED_MODULE_0__);
// Stupid cash-dom table plugin.

const $ = (cash_dom__WEBPACK_IMPORTED_MODULE_0___default());
...
$.fn.stupidsort = function (force_direction) {
  const $this_th = $(this);
  const datatype = $this_th.data('sort') || null; // No datatype? Nothing to do.
  ...
  return this.each(function () {
    ...
    trs.each((index, tr_) => {
      ...
      children.each(function (idx, td_) {
        const td = $(td_);
        let sort_val = td.data('sort-value'); // Store and read from the .data cache for display text only sorts
...
const sortTable = sort_info => {
  ...
  const multicolumn_th_targets = $.map(multicolumn_targets, identifier => get_th(sort_info.$table, identifier));
...
const updateElementData = sort_info => {
  ...
  const sort_dir = $this_th.data('sort-dir'); // Reset siblings
...
//# sourceMappingURL=stupidtable.js.map